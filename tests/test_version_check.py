...
class TestVersionCheck(unittest.TestCase):
    ...
    def test_get_latest_version_from_pypi_success(self, mock_get):
        ...
        mock_get.assert_called_once_with(
            "https://pypi.org/pypi/codeflash/json", timeout=2
        )
    ...
    def test_check_for_newer_minor_version_newer_available(
        self, mock_logger, mock_get_version
    ):
    ...
    @patch("codeflash.code_utils.version_check.logger")
    @patch("codeflash.code_utils.version_check.__version__", "1.0.0")
    def test_check_for_newer_minor_version_newer_major_available(
        self, mock_logger, mock_get_version
    ):
    ...
    def test_check_for_newer_minor_version_no_newer_available(
        self, mock_logger, mock_get_version
    ):
    ...
    def test_check_for_newer_minor_version_patch_update_ignored(
        self, mock_logger, mock_get_version
    ):
    ...
    @patch("codeflash.code_utils.version_check.logger")
    @patch("codeflash.code_utils.version_check.__version__", "1.0.0")
    def test_check_for_newer_minor_version_same_version(
        self, mock_logger, mock_get_version
    ):
    ...
    @patch("codeflash.code_utils.version_check.logger")
    @patch("codeflash.code_utils.version_check.__version__", "1.0.0")
    def test_check_for_newer_minor_version_no_latest_version(
        self, mock_logger, mock_get_version
    ):
    ...
    @patch("codeflash.code_utils.version_check.logger")
    @patch("codeflash.code_utils.version_check.__version__", "1.0.0")
    def test_check_for_newer_minor_version_invalid_version_format(
        self, mock_logger, mock_get_version
    ):
