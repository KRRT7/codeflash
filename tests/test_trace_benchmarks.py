...
def test_trace_benchmarks(tmp_path: Path) -> None:
    ...
    replay_tests_dir = tmp_path / "codeflash_replay_tests"
    ...
    test_class_sort_path = (
        replay_tests_dir / "test_tests_pytest_benchmarks_test_test_benchmark_bubble_sort_example__replay_test_0.py"
    )
...
"""
    ...
    test_sort_path = (
        replay_tests_dir / "test_tests_pytest_benchmarks_test_test_process_and_sort_example__replay_test_0.py"
    )
...
@pytest.mark.ci_skip
def test_trace_multithreaded_benchmark(tmp_path: Path) -> None:
    project_root = Path(__file__).parent.parent / "code_to_optimize"
...
def test_trace_benchmark_decorator(tmp_path: Path) -> None:
    project_root = Path(__file__).parent.parent / "code_to_optimize"
