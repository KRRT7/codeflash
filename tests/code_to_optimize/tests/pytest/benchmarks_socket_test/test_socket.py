...
from tests.code_to_optimize.bubble_sort_picklepatch_test_unused_socket import (
    bubble_sort_with_unused_socket,
)
from tests.code_to_optimize.bubble_sort_picklepatch_test_used_socket import (
...
def test_socket_picklepatch(benchmark):
    ...
    data = {"numbers": list(reversed(range(500))), "socket": s1}
