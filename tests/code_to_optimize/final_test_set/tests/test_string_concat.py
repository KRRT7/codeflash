from tests.code_to_optimize.final_test_set.string_concat import concatenate_strings
...
def test_concatenate_strings_positive():
    assert concatenate_strings(5) == "0, 1, 2, 3, 4, ", (
...
def test_concatenate_strings_large_number():
    ...
    assert len(result) == expected_length, (
        "Failed: Incorrect length for large input 1000"
    )
