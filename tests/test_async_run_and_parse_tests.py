...
async def test_async_sort():
    ...
    test_path = (
        ...
        / "code_to_optimize/tests/pytest/test_async_bubble_sort_temp.py"
    ).resolve()
    test_path_perf = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_async_bubble_sort_perf_temp.py"
    ).resolve()
    fto_path = (
        Path(__file__).parent.resolve() / "code_to_optimize/async_bubble_sort.py"
    ).resolve()
    ...
    try:
        ...
        test_env["CODEFLASH_TEST_MODULE"] = (
            "tests.code_to_optimize.tests.pytest.test_async_bubble_sort_temp"
        )
...
async def test_async_class_sort():
    ...
    test_path = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_async_class_bubble_sort_temp.py"
    ).resolve()
    test_path_perf = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_async_class_bubble_sort_perf_temp.py"
    ).resolve()
    fto_path = (
        Path(__file__).parent.resolve() / "code_to_optimize/async_bubble_sort.py"
    ).resolve()
    ...
    try:
        ...
        test_env["CODEFLASH_LOOP_INDEX"] = "1"
        test_env["CODEFLASH_TEST_MODULE"] = (
            "tests.code_to_optimize.tests.pytest.test_async_class_bubble_sort_temp"
        )
        test_env["CODEFLASH_TEST_CLASS"] = ""
...
async def test_async_perf():
    ...
    test_path = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_async_perf_temp.py"
    ).resolve()
    fto_path = (
        Path(__file__).parent.resolve() / "code_to_optimize/async_bubble_sort.py"
    ).resolve()
    ...
    try:
        ...
        test_env["CODEFLASH_LOOP_INDEX"] = "1"
        test_env["CODEFLASH_TEST_MODULE"] = (
            "tests.code_to_optimize.tests.pytest.test_async_perf_temp"
        )
        test_env["CODEFLASH_TEST_CLASS"] = ""
...
async def test_async_error():
    ...
    test_path = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_async_error_temp.py"
    ).resolve()
    test_path_perf = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_async_error_perf_temp.py"
    ).resolve()
    fto_path = (
        Path(__file__).parent.resolve() / "code_to_optimize/async_bubble_sort.py"
    ).resolve()
...
"""
        ...
        func = FunctionToOptimize(
            function_name="async_error_function",
            parents=[],
            file_path=Path(fto_path),
            is_async=True,
        )
...
"""
        ...
        test_env["CODEFLASH_LOOP_INDEX"] = "1"
        test_env["CODEFLASH_TEST_MODULE"] = (
            "tests.code_to_optimize.tests.pytest.test_async_error_temp"
        )
        test_env["CODEFLASH_TEST_CLASS"] = ""
...
async def test_async_multi():
    ...
    test_path = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_async_multi_temp.py"
    ).resolve()
    test_path_perf = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_async_multi_perf_temp.py"
    ).resolve()
    fto_path = (
        Path(__file__).parent.resolve() / "code_to_optimize/async_bubble_sort.py"
    ).resolve()
    ...
    try:
        ...
        test_env["CODEFLASH_TEST_MODULE"] = (
            "tests.code_to_optimize.tests.pytest.test_async_multi_temp"
        )
        test_env["CODEFLASH_TEST_CLASS"] = ""
        ...
        results_list = test_results.test_results
        function_calls = [
            r for r in results_list if r.id.function_getting_tested == "async_sorter"
        ]
...
async def test_async_edge_cases():
    ...
    test_path = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_async_edge_temp.py"
    ).resolve()
    test_path_perf = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_async_edge_perf_temp.py"
    ).resolve()
    fto_path = (
        Path(__file__).parent.resolve() / "code_to_optimize/async_bubble_sort.py"
    ).resolve()
    ...
    try:
        ...
        test_env["CODEFLASH_LOOP_INDEX"] = "1"
        test_env["CODEFLASH_TEST_MODULE"] = (
            "tests.code_to_optimize.tests.pytest.test_async_edge_temp"
        )
        test_env["CODEFLASH_TEST_CLASS"] = ""
        ...
        assert (
            single_call.stdout == "codeflash stdout: Async sorting list\nresult: [42]\n"
        )
        assert (
            sorted_call.stdout
            == "codeflash stdout: Async sorting list\nresult: [1, 2, 3, 4]\n"
...
def test_sync_sort():
    ...
    test_path = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_sync_in_async_temp.py"
    ).resolve()
    test_path_perf = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_sync_in_async_perf_temp.py"
    ).resolve()
    sync_fto_path = (
        Path(__file__).parent.resolve() / "code_to_optimize/sync_bubble_sort.py"
    ).resolve()
    ...
    try:
        ...
        success, instrumented_test = inject_profiling_into_existing_test(
            ...
            [
                CodePosition(6, 13),
                CodePosition(10, 13),
            ],  # Lines where sync_sorter is called
            func,
            project_root_path,
        ...
        test_env["CODEFLASH_LOOP_INDEX"] = "1"
        test_env["CODEFLASH_TEST_MODULE"] = (
            "tests.code_to_optimize.tests.pytest.test_sync_in_async_temp"
        )
        test_env["CODEFLASH_TEST_CLASS"] = ""
...
async def test_mixed_sorting():
    ...
    test_path = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_mixed_sort_temp.py"
    ).resolve()
    test_path_perf = (
        Path(__file__).parent.resolve()
        / "code_to_optimize/tests/pytest/test_mixed_sort_perf_temp.py"
    ).resolve()
    mixed_fto_path = (
        Path(__file__).parent.resolve() / "code_to_optimize/mixed_sort.py"
    ).resolve()
    ...
    try:
        ...
        async_func = FunctionToOptimize(
            function_name="async_merge_sort",
            parents=[],
            file_path=Path(mixed_fto_path),
            is_async=True,
        )
        ...
        assert (
            "def sync_quick_sort" in instrumented_source
        )  # Should preserve sync function
        ...
        test_env["CODEFLASH_LOOP_INDEX"] = "1"
        test_env["CODEFLASH_TEST_MODULE"] = (
            "tests.code_to_optimize.tests.pytest.test_mixed_sort_temp"
        )
        test_env["CODEFLASH_TEST_CLASS"] = ""
        ...
        async_calls = [
            ...
            if r.id.function_getting_tested == "async_merge_sort"
        ]
