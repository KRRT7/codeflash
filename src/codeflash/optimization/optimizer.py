...
from codeflash.optimization.ranking import rank_all_functions_globally
...
class Optimizer:
    ...
    def run_benchmarks(
        ...
        rule()
        logger.info(f"Running benchmarks in {self.config.benchmarks_root}")
        # Insert decorator
    ...
    def rank_all_functions_globally(
        ...
        return rank_all_functions_globally(file_to_funcs_to_optimize, trace_file_path)
