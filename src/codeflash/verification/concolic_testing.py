...
def generate_concolic_tests(
    ...
    if (
        ...
        if cover_result.returncode == 0:
            ...
            concolic_test_suite_path = (
                concolic_test_suite_dir / "test_concolic_coverage.py"
            )
            concolic_test_suite_path.write_text(
                concolic_test_suite_code, encoding="utf8"
            )
            ...
            function_to_concolic_tests, num_discovered_concolic_tests, _ = (
                discover_unit_tests(concolic_test_cfg)
            )
            logger.info(
